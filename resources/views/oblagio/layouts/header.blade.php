...
<html>
  <head>
    ...
    <link href="{{ og()->assetLte }}dist/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
  ...
  <body class="skin-blue layout-boxed">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="../../index2.html" class="logo"><b>Capsule</b>Sandbox</a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="{{ url('auth/sign-out') }}" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
